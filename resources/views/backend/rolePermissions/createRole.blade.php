            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="d-flex justify-content-between mb-4 ">
                        <h4>Role's</h4>
                        <div class="div">
                            <a href="" data-bs-toggle="modal" data-bs-target="#role" class="btn btn-primary">Add a new role</a>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function() {
                $('#users-table').DataTable({
                    ...
                    order: [[1, 'asc']], // Sort by the second column (name) in ascending order, adjust if necessary
                });
            });
        </script>
        {{-- for table end --}}
        ...
        <script>
            $(document).ready(function(){
                $('#users-table').on('click', '.delete', function(e){
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{ route('admin.role.delete.role', '') }}/" + roleId, // Use the dynamic ID here
                        data: {
                             id : roleId
                        },
                        ...
                        error: function(xhr) {
                            alert('Error deleting role: ' + xhr.responseText); // Handle errors if needed
                        }
                    });
                });
            });
